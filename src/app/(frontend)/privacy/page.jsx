...
import { FaUser, FaEnvelope, FaDesktop, FaFileAlt, FaCreditCard, FaBullhorn, FaChartLine } from "react-icons/fa";
import { FaBullseye, FaBalanceScale, FaEnvelopeOpenText, FaCog, FaShieldAlt,  FaBell } from "react-icons/fa";
...
const PrivacyPolicyPage = () => {
  return (
    ...
    We recognize that your privacy is very important and take it seriously. This Privacy Policy describes how Outliny Technologies (<span className="italic">"Outliny", "we", "us", or "our"</span>) collects, uses, discloses, and secures personal information when:
  </p>
  <ul className="list-disc ml-6 md:ml-11 mb-4 space-y-2 text-sm sm:text-base font-roboto">
    <li>You visit or interact with our platform at <a href="https://www.outliny.com" className="underline">www.outliny.com</a> and related services (the “Platform”)</li>
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    By accessing or using the Services, you consent to our use of your information as described in this Privacy Policy. We will not use or share your personal information with anyone except as outlined here.
  </p>
  <p className="mb-4 text-sm sm:text-base font-roboto">
    This policy meets our obligations under global data protection regulations. We may update this Privacy Policy periodically and will post any changes on this page.
  </p>
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    Outliny is a secure, developer-focused platform that empowers enterprises to design, manage, and deliver consistent branding across all internal and external communications&mdash;especially emails and PDF documents. Whether you're building HRMS notifications, CRM emails, dynamic invoices, or personalized PDF attachments, Outliny helps you streamline and centralize all your branded communication templates in one place.
  </p>
  <ul className="list-disc ml-6 md:ml-11 mb-4 space-y-2 text-sm sm:text-base font-roboto">
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    Outliny is open-source and developer-friendly&mdash;use our hosted version with a generous free tier or self-host using our GitHub codebase.
  </p>
  ...
  <ul className="ml-6 md:ml-11 mb-4 text-sm sm:text-base font-roboto">
    ...
    <li className="mb-1">🌐 Website: <a href="https://www.outliny.com" className="underline">www.outliny.com</a></li>
  </ul>
  <p className="mb-4 text-sm sm:text-base font-roboto">
    We are here to support secure, branded, and scalable communication for your organization.
        ...
        <div>
        <h2 className="text-2xl md:text-[30px] font-semibold text-white mt-12 mb-3">
  ...
  <ul className="list-disc ml-6 md:ml-11 mb-4 space-y-2 text-sm sm:text-base font-roboto">
    ...
    <li><span className="font-medium">Correction:</span> Request correction of incomplete or inaccurate data.</li>
    <li><span className="font-medium">Erasure:</span> Request deletion of your data when it’s no longer necessary.</li>
    <li><span className="font-medium">Objection:</span> Object to data processing based on legitimate interest or for direct marketing.</li>
    <li><span className="font-medium">Restriction:</span> Request a temporary pause in data processing under certain conditions.</li>
    <li><span className="font-medium">Portability:</span> Request to receive your data in a machine-readable format.</li>
    <li><span className="font-medium">Withdraw Consent:</span> Where processing is based on consent, you may withdraw it at any time.</li>
  </ul>
  <p className="mb-3 text-sm sm:text-base font-roboto">
    To exercise any of these rights, email us at <a href="mailto:info@softinator.com" className="underline">info@softinator.com</a>. We may ask you to verify your identity before proceeding. We aim to respond within one month.
  </p>
        </div>
        ...
        <div>
        <h2 className="text-2xl md:text-[30px] font-semibold text-white mt-12 mb-3">
    3. Whose Personal Data We Collect
  </h2>
  <p className="mb-3 text-sm sm:text-base font-roboto">
  ...
  <p className="mb-3 text-sm sm:text-base font-roboto">
    Outliny collects minimal and essential personal data to deliver our services effectively, support security and compliance, improve functionality, and provide support when needed. We are fully committed to respecting user privacy and following strict security protocols aligned with our ISO 27001:2022 and SOC 2 Type II certifications.<br/>
    We do not store or access your content (email bodies, PDFs, variables, etc.) unless explicitly enabled for debugging. Logs are disabled by default.
  </p>
  <h3 className="text-lg md:text-xl font-medium mb-3 text-white font-inter">
    Information You Provide to Us
  </h3>
  <p className="mb-3 text-sm sm:text-base font-roboto">
    While using Outliny, you may share certain information that identifies you as an individual ("Personal Data"). Below is an overview of the types of personal data we may collect:
  </p>
...
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-3">
    ...
    return (
      <div
        ...
        className={`bg-[#08090a] border border-gray-700 rounded-xl p-8 ${
          isIncompleteRow ? 'lg:col-span-3 flex flex-col  justify-self-center lg:w-[33%]' : ''
        }`}
      >
        <div className="flex items-center gap-3 mb-3">
          {section.icon}
  ...
  <p className="mb-3 mt-4 text-sm sm:text-base font-roboto">
    We do not collect any special categories of personal data (e.g. ethnicity, political beliefs, health data) or knowingly collect information from individuals under the age of 18.
  </p>
  <h3 className="text-lg md:text-xl font-medium mb-3 text-white font-inter">
    Aggregated Data
  </h3>
  <p className="mb-3 text-sm sm:text-base font-roboto">
    We may collect, use, and share aggregated, anonymized data (e.g., total number of templates created, average API response times) to monitor platform performance and usage patterns. This data does not identify any individual and is used solely for improving our services.
  </p>
  <h3 className="text-lg md:text-xl font-medium mb-3 text-white font-inter">
    We Do Not Collect or Process:
  </h3>
  <ul className="list-disc ml-6 md:ml-11 mb-4 space-y-2 text-sm sm:text-base font-roboto">
    <li>Special categories of personal data (e.g., race, religion, political opinions, biometric data)</li>
  ...
  <p className="mb-3 text-sm sm:text-base font-roboto">
    You can manage or disable cookies via your browser settings. Some features may not function properly without cookies.
  </p>
        </div>
  ...
  <p className="mb-3 text-sm sm:text-base font-roboto">
    You can request data deletion by emailing <a href="mailto:info@softinator.com" className="underline">info@softinator.com</a>
  </p>
        </div>
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    Your data may be stored or processed in countries outside your jurisdiction. We implement standard contractual clauses and safeguard mechanisms to ensure lawful international transfers.
  </p>
   </div>
  ...
  <ul className="list-disc ml-6 md:ml-11 mb-4 space-y-2 text-sm sm:text-base font-roboto">
    <li>If you choose to log in via Google: We access basic profile data (name, email) for authentication only.</li>
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    Outliny’s platform may contain links to third-party websites. We are not responsible for the privacy practices of those websites. Always review their privacy policies separately.
  </p>
  </div>
  ...
  <p className="mb-4 text-sm sm:text-base font-roboto">
    We may revise this Privacy Policy periodically. Changes will be posted here with an updated “Effective Date.” Your continued use of Outliny after any update constitutes your acceptance of the revised policy.
  </p>
  </div>
  ...
  <ul className="ml-6 md:ml-11 mb-3 text-sm sm:text-base font-roboto">
    <li className="mb-1">📩 Email: <a href="mailto:info@softinator.com" className="underline">info@softinator.com</a></li>
  </ul>
