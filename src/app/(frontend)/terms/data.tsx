    ...
    content: (
      <ul className="list-disc ml-6 md:ml-11 space-y-8 text-sm sm:text-base font-roboto">
        ...
        <li>
          ...
          User Content, and Outliny is the &quot&quot;Data Processor.&quot&quot; We will only process data according to
    ...
    content: (
      <>
        ...
        <p className="ml-6 mt-4">
          In no event shall Outlinys aggregate liability for all claims relating to the service
  ...
  },
  {
    ...
    content: (
      <p className="ml-6">
        ...
        losses, liabilities, costs, or debt, and expenses (including but not limited to attorneys
