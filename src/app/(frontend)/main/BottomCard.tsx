...
const BottomCard: React.FC = () => {
 ...
 const togglePlay = () => {
  ...
  return (
    <div className="w-full px-4 md:px-8 lg:px-16 text-white flex flex-col gap-6 mt-10 md:mt-20 mx-auto ">
      {/* First Section */}
 ...
 <div className="bg-[#0E0E0E] rounded-2xl border border-[#202020] w-full md:w-1/2 lg:w-[48%] max-h-[600px]  overflow-hidden">
          <div className="p-6 flex flex-col gap-4 h-full">
            ...
            <p className="text-[#878685] text-sm sm:text-base leading-relaxed">
              Drag-and-drop builders are great—but real power comes from understanding what’s under the hood.
        ...
        />
          ...
          <div className="mt-5 p-2 ">
            ...
            <p className="mt-3 text-[#878685] text-sm sm:text-base">
              Get started quickly with the foundational tools of Outliny. From drag-and-drop template editors
              to simple API calls using Jinja variables, everything is designed to minimize setup and maximize productivity.
            </p>
          </div>
        </div>
