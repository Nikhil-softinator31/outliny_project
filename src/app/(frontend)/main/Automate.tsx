...
const Main: React.FC = () => {
  ...
  return (
    <div className="font-poppins bg-gradient-custom min-h-[600px] md:h-[800px] lg:h-[650px] flex items-center justify-center px-4 mt-20  ">
      <div className="flex flex-col lg:flex-row justify-center items-center w-full max-w-[1200px] gap-10 lg:gap-20 mt-10 md:mt-0">
        ...
        <div
          ...
          className="flex flex-col gap-3 text-center lg:text-left max-w-lg lg:pl-4"
        >
        ...
        <div ref={rightSectionRef} className="flex flex-col gap-4">
          {/* Buttons */}
          <div className="bg-[#171819] p-3 rounded-lg flex flex-wrap justify-center  gap-2 lg:w-[95%] xl:w-full" >
          ...
          {/* Image Display */}
          <div className="flex justify-center items-center bg-custom-gradient h-[250px] sm:h-[279px] w-full sm:w-[500px] md:w-[600px] lg:w-[550px]  xl:w-[700px] rounded-lg mt-2 mx-auto">
            <Image
              ref={imageRef}
              src={
